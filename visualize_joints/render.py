...
class PLYSequenceViewer:
    ...
    def _analyze_motion(self):
        ...
        print(
            f"  Start position: [{self.translations[0, 0]:.3f}, {self.translations[0, 1]:.3f}, {self.translations[0, 2]:.3f}]"
        )
        print(
            f"  End position:   [{self.translations[-1, 0]:.3f}, {self.translations[-1, 1]:.3f}, {self.translations[-1, 2]:.3f}]"
        )
